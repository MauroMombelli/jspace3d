...
public class MainClient {
	...
	static {
		File lwjglNativeFolder = new File(System.getProperty("user.dir"), "lib"
				+ File.separator + "lwjgl-2.7.1" + File.separator + "native");
	...
	private boolean login() {
		...
		try {
			...
			System.out.println("SHA1 size:"
					+ SHA1Calculator.SHA1(mioLogin.getPass()).length());
